																		...
																		<p
																			...
																			<span style="font-size:34px;"><strong><span
																						style="font-size:34px;"><span
																							style="color:#2190e3;font-size:34px;">Need Review</span></span></strong></span>
																		</p>
																	</div>
																</div>
															</td>
																	...
																	<div class=""
																		...
																		<p
																			...
																			<span style="color:#000000;"><span
																					style="font-size:18px;">Your <strong>' . $sub_name . '</strong> assignment need review. Login to your LARA dashboard to see details.</span></span></p>
																	</div>
																</div>
															</td>
														</tr>
...
if($v_status == 'not verified' || $v_status == 'need review'){
$sql = "UPDATE document SET remarks='$remarks', v_status='need review' where doc_id='$doc_id'";
