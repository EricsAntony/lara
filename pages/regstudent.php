        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Register</strong> Student</h2>
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                ...
                                <div class="form-group form-float">
                                    <input type="text" class="form-control" placeholder="Admission Number" name="adm" required>
                                </div>
                                <div class="form-group form-float">
                                    <input type="text" class="form-control" placeholder="Mobile" name="phn" required>
                                </div>
                                <div class="form-group form-float">
                                    <input type="text" class="form-control" placeholder="Batch(A/B/C)" name="batch" required>
                                </div>
                                <div class="form-group form-float">
