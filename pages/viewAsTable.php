...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="admin_dash.php"><img src="assets/images/logo.svg" width="25" alt="Aero"><span class="m-l-10">LARA</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
            ...
            <li class="active open"><a href="admin_dash.php"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
            ...
            <ul class="ml-menu">
                    <li><a href="#largeModal" data-toggle="modal" data-target="#largeModal">Add a subject</a></li>
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Classrooms</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin_dash.php"><i class="zmdi zmdi-home"></i> Home</a></li>
