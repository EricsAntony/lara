...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <a class="image" href="st_profile.php"><img src="assets/images/profile_av.jpg" alt="User"></a>
                    <div class="detail">
                        <h4><?php echo $_SESSION['sname']?></h4>
                    </div>
                </div>
            </li>
            <li class="active open"><a href="st_dash.php"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a>
            </li>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-red">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-link waves-effect text-light" id="logout1">LOG OUT</button>
...
<script src="../../js/st_logout.js"></script>
