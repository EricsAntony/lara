                ...
                <div class="col-lg-4 col-sm-12">
                    <form class="card auth_form" id="sup" method="post" onkeyup="return checkInp()">
                        ...
                        <div class="body">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Year of admission" readonly id="yoa">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="zmdi zmdi-calendar-alt"></i></span>
                                </div>
                            </div>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Mobile" required id="mob" name="mob">
                                <div class="input-group-append">
                            ...
                            <input type="buttton" class="btn btn-primary btn-block waves-effect waves-light" value="SIGN UP"  id="sbtn">
                            
                            <div class="signin_with mt-3">
                                <a class="link" href="login.php">You already have a registered?</a>
                            </div>
                        </div>
                    </form>
