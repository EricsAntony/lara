...
if (isset($_SESSION['teacher'])) {
            ...
            <div class="body_scroll">
                <div class="block-header">
                    <div class="row">
                        ...
                        <a class="btn btn-primary float-right " type="button" href='view_t_upload.php?sub_id=<?php echo $subid?>'>Upload</a>
                        <a class="btn btn-primary float-right " type="button" href='t_upload.php?sub_id=<?php echo $subid?>'>Your Uploads</a>
                ...
                <div class="modal-body">
                    <form id="form_validation" method="POST">
                        <div class="form-group form-float">
                            <input type="text" id="topic" class="form-control" placeholder="Assignment topic" required>
                        </div>
                        <div class="form-group form-float">
                            <div class="input-group masked-input">
                                ...
                                <input type="date" class="form-control date" placeholder="Due date Ex: 30/07/2016"
                                    id="ddate">
                            </div>
                        </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_validation1" method="POST">
                        ...
                        <!-- <div class="form-group form-float">
                            <textarea cols="30" rows="5" placeholder="Description" class="form-control no-resize"
                                required></textarea>
                        </div> -->
                </div>
                <div class="modal-footer">
    ...
    <script src="../js/view_assignment.js"></script>
